...
describe('Paths', () => {
  ...
  describe('getModelsPath', () => {
    it('should return path containing models', () => {
      const modelsPath = getModelsPath();
      expect(modelsPath).toContain('models');
    });

    it('should return path under app data directory', () => {
      const modelsPath = getModelsPath();
      const appDataPath = getAppDataPath();
      expect(modelsPath.startsWith(appDataPath)).toBe(true);
    });
  });

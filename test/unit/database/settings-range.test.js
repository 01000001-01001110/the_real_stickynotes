...
describe('Settings Range Validation', () => {
  ...
  describe('Range validation integration', () => {
    it('should validate all numeric settings with ranges (v2 includes VAD settings)', () => {
      const testCases = [
        ...
        // v2 Sherpa-ONNX VAD settings (replaced whisper.chunkDuration)
        { key: 'whisper.vadThreshold', valid: 0.5, invalid: 1.5 },
        { key: 'whisper.vadMinSilence', valid: 0.25, invalid: 5.0 },
        { key: 'whisper.vadMaxSpeech', valid: 5.0, invalid: 50.0 },
        { key: 'whisper.numThreads', valid: 4, invalid: 20 },
      ];
